...
import { MatListModule, MatIconModule, MatSortModule, Sort } from '@angular/material';
...
describe('EnthusiastsListComponent', () => {
 ...
 // sortedData: Array<enthusiast>;
    ...
    expect(component.sortedData[0].activity.value).not.toBe(component.enthusiasts_list[0].activity.value);
